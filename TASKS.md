...
## Features (larger)
- [~] K1b. **Cabinet engine — next steps**: sink (C42), hob (C43), "Kitchen run" set + wall-mount fix (C44) shipped. TODO: wall-aware auto-arrange (snap a run to a chosen wall); corner/blind units.
