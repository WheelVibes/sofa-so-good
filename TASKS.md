...
- [x] R13. **Polygon/L-shape-aware room labels** — shared `roomCentroid.ts` `roomLabelPoint` used by minimap + editor + report; labels sit inside non-rect rooms. 4 tests. (CHANGELOG)
...
- [x] R11. **Regression guards for the view/edit core** — unit tests for canEditScene + editableRoomIds. (CHANGELOG)
