...
- **Per-LOD texture variants** — for performance on lower-end devices once the 2K KTX2 baseline is shipped. See [asset-population spec — Out of scope](docs/superpowers/specs/2026-04-26-asset-population-design.md#out-of-scope-for-this-spec).
...
- **Material rendering: solid swatch → KTX2 PBR maps** — the placeholder noted in [src/materials/builtinCatalog.ts](src/materials/builtinCatalog.ts) is replaced as part of the asset-population implementation. Track until that lands.
