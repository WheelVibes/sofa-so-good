...
| 24 | **RD-407** | PHOTO-BEVELS. **CASE GOODS DONE (v0.2.0.18):** Bookshelf/CabinetModule/CabinetCorner/Wardrobe carcasses+doors+drawers beveled. **REMAINING:** appliance bodies (Refrigerator/Oven/Stove/RangeHood/Dishwasher/Microwave/WashingMachine/WineCooler) — share the brushed-metal `applianceBody` path, needs a coordinated pass. | MED photoreal | M | appliance primitives via `primitives/shared.tsx:applianceBody` | `cg-primitives` |
