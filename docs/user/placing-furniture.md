...
| Action | Shortcut |
| --- | --- |
| Rotate | <kbd>R</kbd> (90°) · <kbd>Shift</kbd>+<kbd>R</kbd> (15°) |
| Flip | <kbd>F</kbd> |
| Duplicate | <kbd>⌘D</kbd> / <kbd>Ctrl</kbd>+<kbd>D</kbd> |
| Copy / paste | <kbd>⌘C</kbd> / <kbd>⌘V</kbd> |
| Nudge | arrow keys (hold for continuous; <kbd>Shift</kbd> = fine) |
| Delete | <kbd>Del</kbd> |
...
Some items combine: a mattress rests on a bed frame, sofa sections snap together,
chairs gather around a table. Two ways to do it:

- **Drag‑snap** — drag a compatible piece onto its base and it clicks into place.
- **Inspector** — pick a base, then choose **Complete with → Place on this**.

The combined pieces share a group, so they move together afterwards.
