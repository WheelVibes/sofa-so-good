...
| **MAT-002** | Tile/ceramic: glaze orange-peel micro-normal + glaze↔grout roughness contrast | S | `procedural/patterns/tile.ts`, `generators.test.ts` | **G-tile** (`tile.ts`) + **G-gentest** | RD-401 landed |
