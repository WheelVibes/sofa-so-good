...
- **Carpet** (floor-carpet) — Poly Haven, [source](https://polyhaven.com/a/dirty_carpet), CC0
- **Concrete floor** (floor-concrete) — Poly Haven, [source](https://polyhaven.com/a/concrete_floor_02), CC0
- **Parquet** (floor-parquet) — Poly Haven, [source](https://polyhaven.com/a/brown_planks_03), CC0
- **Marble** (floor-tile-marble) — Poly Haven, [source](https://polyhaven.com/a/marble_01), CC0
- **Stone tiles** (floor-tile-stone) — Poly Haven, [source](https://polyhaven.com/a/floor_tiles_06), CC0
- **Mosaic tiles** (floor-tile-white) — Poly Haven, [source](https://polyhaven.com/a/square_tiles_03), CC0
- **Natural wood** (floor-wood-natural) — Poly Haven, [source](https://polyhaven.com/a/wood_floor), CC0
- **Oak planks** (floor-wood-oak) — Poly Haven, [source](https://polyhaven.com/a/wood_floor_deck), CC0
- **Walnut planks** (floor-wood-walnut) — Poly Haven, [source](https://polyhaven.com/a/wood_floor_worn), CC0
- **Beige wall** (wall-beige) — Poly Haven, [source](https://polyhaven.com/a/beige_wall_001), CC0
- **Red brick** (wall-brick) — Poly Haven, [source](https://polyhaven.com/a/medieval_red_brick), CC0
- **Concrete wall** (wall-concrete) — Poly Haven, [source](https://polyhaven.com/a/concrete_wall_007), CC0
- **Denim fabric** (wall-fabric-denim) — Poly Haven, [source](https://polyhaven.com/a/denim_fabric), CC0
- **Greige leather** (wall-leather-white) — Poly Haven, [source](https://polyhaven.com/a/leather_white), CC0
- **Metal plate** (wall-metal-plate) — Poly Haven, [source](https://polyhaven.com/a/metal_plate), CC0
- **Plastered wall** (wall-plaster) — Poly Haven, [source](https://polyhaven.com/a/plastered_wall_02), CC0
- **Stone brick** (wall-stone-brick) — Poly Haven, [source](https://polyhaven.com/a/stone_brick_wall_001), CC0
