...
export const OUTDOOR_DEFS = {
  ...
  'bistro-table': {
    ...
    category: 'outdoor',
    primitive: 'BistroTable',
    // Round top over a pedestal foot. Square bbox = the diameter (a true circle
    // would only free the corners, so this is a conservative honest footprint).
    defaultFootprint: { w: 0.6, d: 0.6, h: 0.71 },
    ...
    paramSchema: [
      ...
      { kind: 'color', key: 'color', label: 'Frame', default: '#3a4038' },
      {
        kind: 'enum',
        key: 'finish',
        label: 'Finish',
  ...
  'folding-chair': {
    ...
    id: 'folding-chair',
    name: 'Folding chair',
    keywords: ['folding', 'bistro', 'cafe', 'balcony', 'patio', 'outdoor', 'deck', 'foldable'],
    category: 'outdoor',
    primitive: 'FoldingChair',
    defaultFootprint: { w: 0.42, d: 0.5, h: 0.79 },
    frontClearance: 0.3,
    paramSchema: [
      { kind: 'color', key: 'color', label: 'Frame', default: '#3a4038' },
      {
