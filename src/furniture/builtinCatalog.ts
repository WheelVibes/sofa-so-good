...
export const BUILTIN_CATALOG: Record<FurnitureType, FurnitureDef> = {
  ...
  'changing-table': {
    ...
    paramSchema: [
      { kind: 'number', key: 'width', label: 'Width', min: 0.8, max: 1.2, step: 0.05, default: 0.95, unit: 'm' },
      { kind: 'number', key: 'depth', label: 'Depth', min: 0.45, max: 0.65, step: 0.02, default: 0.55, unit: 'm' },
  ...
  sideboard: {
    ...
    footprintParams: { w: 'width', d: 'depth' },
    paramSchema: [
      { kind: 'number', key: 'width', label: 'Width', min: 1.0, max: 2.2, step: 0.1, default: 1.6, unit: 'm' },
      { kind: 'number', key: 'depth', label: 'Depth', min: 0.35, max: 0.5, step: 0.01, default: 0.42, unit: 'm' },
  ...
  ottoman: {
    ...
    footprintParams: { w: 'width', d: 'depth' },
    paramSchema: [
      { kind: 'number', key: 'width', label: 'Width', min: 0.4, max: 1.1, step: 0.05, default: 0.6, unit: 'm' },
      { kind: 'number', key: 'depth', label: 'Depth', min: 0.4, max: 0.7, step: 0.05, default: 0.6, unit: 'm' },
      { kind: 'number', key: 'height', label: 'Height', min: 0.32, max: 0.5, step: 0.02, default: 0.42, unit: 'm' },
      {
        kind: 'enum',
        key: 'shape',
        label: 'Shape',
  ...
  'chaise-lounge': {
    ...
    paramSchema: [
      { kind: 'number', key: 'width', label: 'Length', min: 1.5, max: 2.0, step: 0.05, default: 1.75, unit: 'm' },
      { kind: 'number', key: 'depth', label: 'Seat width', min: 0.6, max: 0.85, step: 0.02, default: 0.72, unit: 'm' },
  ...
  'floor-vase': {
    ...
    paramSchema: [
      { kind: 'number', key: 'height', label: 'Vase height', min: 0.4, max: 1.0, step: 0.05, default: 0.7, unit: 'm' },
      {
        kind: 'enum',
        key: 'shape',
        label: 'Shape',
  ...
  'wall-mirror': {
    ...
    paramSchema: [
      { kind: 'number', key: 'width', label: 'Width', min: 0.4, max: 1.2, step: 0.05, default: 0.7, unit: 'm' },
      { kind: 'number', key: 'height', label: 'Height', min: 0.4, max: 1.6, step: 0.05, default: 1.0, unit: 'm' },
      { kind: 'number', key: 'mountHeight', label: 'Hang height', min: 0.9, max: 1.9, step: 0.05, default: 1.5, unit: 'm' },
      {
        kind: 'enum',
        key: 'shape',
        label: 'Shape',
