...
export const BUILTIN_CATALOG: Record<FurnitureType, FurnitureDef> = {
  ...
  'towel-ladder': {
    ...
    // Freestanding floor piece (not mounted); footprint covers the leaning base.
    defaultFootprint: { w: 0.46, d: 0.3, h: 1.4 },
    footprintParams: { w: 'width' },
    paramSchema: [
      {
        kind: 'number',
      ...
      { kind: 'integer', key: 'rungs', label: 'Rungs', min: 3, max: 7, default: 5 },
      {
        kind: 'enum',
        key: 'finish',
        label: 'Finish',
