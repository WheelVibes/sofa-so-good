...
export const LAYOUT_PRESETS: LayoutPreset[] = [
  ...
  },
  {
    ...
    livingDining: [
      ...
      { id: 'es-sectional', defId: 'sofa-lshape', position: [9.95, 2.75], rotation: -Math.PI / 2, props: { width: 2.6, depth: 0.95, chaise: 1.0, chaiseSide: 'right', color: '#4a5a63', material: 'fabric', pattern: 'plain', pillowColor: '#c9a24b' } },
      { id: 'es-rug', defId: 'rug', position: [11.0, 2.75], rotation: 0, props: { width: 2.2, depth: 2.6, color: '#cfc6b4', borderColor: '#3a352c', pattern: 'plain' } },
      { id: 'es-coffee', defId: 'coffee-table', position: [11.05, 2.75], rotation: 0, props: { shape: 'oval', width: 1.1, depth: 0.6, color: '#3f2f22', finish: 'wood' } },
      { id: 'es-feature', defId: 'feature-wall', position: [12.53, 2.75], rotation: -Math.PI / 2, props: { width: 2.8, height: 2.55, style: 'slat', color: '#4a3a2c', finish: 'wood' } },
      // Media credenza — a long sideboard under the wall-mounted TV.
      { id: 'es-credenza', defId: 'sideboard', position: [12.32, 2.75], rotation: -Math.PI / 2, props: { width: 2.0, depth: 0.42, bays: 4, front: 'mixed', legs: 'tapered', handle: 'bar', color: '#4a3a2c', finish: 'wood' } },
      { id: 'es-tv', defId: 'tv-wall', position: [12.45, 2.75], rotation: -Math.PI / 2, props: { size: '65', mount: 'wall', mountHeight: 1.35, screen: 'on', screenContent: 'sunset' } },
      { id: 'es-cove', defId: 'cove-light', position: [12.5, 2.6], rotation: -Math.PI / 2, props: { length: 3.4, mountHeight: 2.38 } },
      // Bar cart tucked against the east wall between lounge and dining.
      { id: 'es-barcart', defId: 'bar-cart', position: [12.05, 4.55], rotation: 0, props: { tiers: 3, frame: 'brass', shelf: 'glass' } },
      { id: 'es-plant', defId: 'potted-plant', position: [9.0, 4.5], rotation: 0, props: { type: 'fiddle', size: 'large', potShape: 'cylinder', leafColor: '#3f7a3f' } },
      { id: 'es-lamp', defId: 'floor-lamp', position: [11.5, 1.85], rotation: 0, props: { base: 'tripod', shade: 'drum' } },
      ...
      { id: 'es-curtain', defId: 'curtains', position: [10.85, 1.5], rotation: 0, props: { width: 2.8, height: 2.3, color: '#cfc6b4' } },
      // ── Dining zone (south), open to the lounge ──
      { id: 'es-dining', defId: 'dining-table-4', position: [10.7, 5.75], rotation: 0, props: { seats: '6', shape: 'oval', topColor: '#3f2f22', legColor: '#2c2118' } },
      { id: 'es-dc-n1', defId: 'dining-chair', position: [9.95, 5.05], rotation: 0, props: { style: 'upholstered', seatColor: '#4a5a63' } },
      { id: 'es-dc-n2', defId: 'dining-chair', position: [10.7, 5.05], rotation: 0, props: { style: 'upholstered', seatColor: '#4a5a63' } },
      { id: 'es-dc-n3', defId: 'dining-chair', position: [11.45, 5.05], rotation: 0, props: { style: 'upholstered', seatColor: '#4a5a63' } },
      { id: 'es-dc-s1', defId: 'dining-chair', position: [9.95, 6.45], rotation: Math.PI, props: { style: 'upholstered', seatColor: '#4a5a63' } },
      { id: 'es-dc-s2', defId: 'dining-chair', position: [10.7, 6.45], rotation: Math.PI, props: { style: 'upholstered', seatColor: '#4a5a63' } },
      { id: 'es-dc-s3', defId: 'dining-chair', position: [11.45, 6.45], rotation: Math.PI, props: { style: 'upholstered', seatColor: '#4a5a63' } },
      { id: 'es-pendant', defId: 'ceiling-light', position: [10.7, 5.75], rotation: 0, props: { style: 'pendant', shade: 'drum' } },
      { id: 'es-shoe', defId: 'shoe-cabinet', position: [12.35, 7.45], rotation: -Math.PI / 2, props: { width: 0.9, depth: 0.3 } },
    ],
  },
  {
    id: 'broken-plan',
    name: 'Broken-Plan Living',
    description: 'Re-modelled L/D: a slat screen zones the lounge from the dining without closing it.',
    dryFloor: 'floor-wood-oak',
    wall: 'wall-paint-warm',
    style: {},
    livingDining: [
      // ── Lounge (north), facing the east media wall ──
      { id: 'bp-sofa', defId: 'sofa-3seat', position: [9.6, 2.55], rotation: Math.PI / 2, props: { color: '#7d8a82', material: 'fabric', pattern: 'plain', pillowColor: '#b5683f' } },
      { id: 'bp-console', defId: 'tv-console', position: [12.1, 2.45], rotation: -Math.PI / 2, props: { width: 1.6, base: 'legs', color: '#5a3f2a', finish: 'wood' } },
      { id: 'bp-tv', defId: 'tv-wall', position: [12.45, 2.45], rotation: -Math.PI / 2, props: { size: '55', mount: 'wall', mountHeight: 1.3, screen: 'on', screenContent: 'landscape' } },
      { id: 'bp-soundbar', defId: 'soundbar', position: [12.42, 2.45], rotation: -Math.PI / 2, props: { width: 1.2, mountHeight: 0.78, grille: 'fabric', color: '#1c1c1e' } },
      { id: 'bp-cove', defId: 'cove-light', position: [12.5, 2.6], rotation: -Math.PI / 2, props: { length: 3.4, mountHeight: 2.38 } },
      { id: 'bp-rug', defId: 'rug', position: [10.95, 2.55], rotation: 0, props: { width: 2.0, depth: 1.8, color: '#d8cdb8', borderColor: '#9a8a6a', pattern: 'plain' } },
      { id: 'bp-coffee', defId: 'coffee-table', position: [10.95, 2.55], rotation: Math.PI / 2, props: { shape: 'oval', width: 1.0, depth: 0.55, color: '#5a3f2a', finish: 'wood' } },
      { id: 'bp-ottoman', defId: 'ottoman', position: [11.0, 3.4], rotation: 0, props: { shape: 'round', width: 0.5, depth: 0.5, color: '#b5683f', material: 'fabric', tufting: 'buttons' } },
      ...
      { id: 'bp-curtain', defId: 'curtains', position: [10.85, 1.5], rotation: 0, props: { width: 2.8, height: 2.3, color: '#e6ddca' } },
      // ── The zoning screen between lounge and dining (partial width → walkway east) ──
      { id: 'bp-divider', defId: 'room-divider', position: [9.95, 3.95], rotation: 0, props: { width: 1.5, height: 1.8, style: 'slat', color: '#5a3f2a', finish: 'wood' } },
      // ── Dining (south) ──
      { id: 'bp-dining', defId: 'dining-table-4', position: [10.7, 5.75], rotation: 0, props: { seats: '6', shape: 'oval', topColor: '#5a3f2a', legColor: '#3a2c1d' } },
      { id: 'bp-dc-n1', defId: 'dining-chair', position: [9.95, 5.05], rotation: 0, props: { style: 'wood', seatColor: '#9a6b3f' } },
      { id: 'bp-dc-n2', defId: 'dining-chair', position: [10.7, 5.05], rotation: 0, props: { style: 'wood', seatColor: '#9a6b3f' } },
      { id: 'bp-dc-n3', defId: 'dining-chair', position: [11.45, 5.05], rotation: 0, props: { style: 'wood', seatColor: '#9a6b3f' } },
      { id: 'bp-dc-s1', defId: 'dining-chair', position: [9.95, 6.45], rotation: Math.PI, props: { style: 'wood', seatColor: '#9a6b3f' } },
      { id: 'bp-dc-s2', defId: 'dining-chair', position: [10.7, 6.45], rotation: Math.PI, props: { style: 'wood', seatColor: '#9a6b3f' } },
      { id: 'bp-dc-s3', defId: 'dining-chair', position: [11.45, 6.45], rotation: Math.PI, props: { style: 'wood', seatColor: '#9a6b3f' } },
      { id: 'bp-pendant', defId: 'ceiling-light', position: [10.7, 5.75], rotation: 0, props: { style: 'pendant', shade: 'drum' } },
      { id: 'bp-shoe', defId: 'shoe-cabinet', position: [12.35, 7.45], rotation: -Math.PI / 2, props: { width: 0.9, depth: 0.3 } },
    ],
  },
  {
    id: 'wfh-studio',
  ...
  },
  {
    ...
    wall: 'wall-paint-greige',
    style: {
      'sofa-3seat': { color: '#8f857a', material: 'fabric', pattern: 'plain', pillowColor: '#3a352c' },
    ...
    rooms: {
      ...
      mainBedroom: [
        { id: 'default-main-bed', defId: 'bed-queen', position: [1.5, 1.25], rotation: 0, props: { frameColor: '#4a3a2c', beddingColor: '#e8e2d6', headboardStyle: 'upholstered', headboardColor: '#8f857a', throwColor: '#6b5f4e', pillowColor: '#ffffff' } },
        { id: 'default-main-ns-l', defId: 'nightstand', position: [0.475, 0.55], rotation: 0, props: { color: '#4a3a2c' } },
        { id: 'default-main-ns-r', defId: 'nightstand', position: [2.525, 0.55], rotation: 0, props: { color: '#4a3a2c' } },
        { id: 'default-main-lamp-l', defId: 'table-lamp', position: [0.475, 0.55], rotation: 0, props: { surfaceHeight: 0.52, shade: 'drum' } },
        { id: 'default-main-lamp-r', defId: 'table-lamp', position: [2.525, 0.55], rotation: 0, props: { surfaceHeight: 0.52, shade: 'drum' } },
        { id: 'default-main-wardrobe', defId: 'wardrobe-3door', position: [2.70, 1.95], rotation: -Math.PI / 2, props: { width: 1.4, doorStyle: 'sliding', color: '#6b5f4e' } },
        { id: 'default-main-bench', defId: 'bench', position: [1.5, 2.55], rotation: 0, props: { style: 'upholstered', material: 'velvet', color: '#7d7468', legColor: '#3a2c1d', sheen: 0.3 } },
        { id: 'default-main-rug', defId: 'rug', position: [1.4, 2.0], rotation: 0, props: { width: 1.8, depth: 1.2, color: '#cfc6b8', borderColor: '#5a4a32' } },
        { id: 'default-main-pendant', defId: 'ceiling-light', position: [1.5, 1.6], rotation: 0, props: { style: 'flush' } },
        { id: 'default-main-curtain', defId: 'curtains', position: [0.28, 2.2], rotation: Math.PI / 2, props: { width: 2.3, height: 2.3, color: '#d8cdb8' } },
        { id: 'default-main-sconce-l', defId: 'wall-sconce', position: [0.45, 0.30], rotation: 0, props: { mountHeight: 1.45 } },
        { id: 'default-main-sconce-r', defId: 'wall-sconce', position: [2.55, 0.30], rotation: 0, props: { mountHeight: 1.45 } },
      ],
    },
  },
  {
    id: 'family-nursery',
    name: 'Family Nursery',
    description: 'Soft warm flat; Bedroom 3 re-modelled as a nursery (crib + changing + nursing nook).',
    dryFloor: 'floor-wood-ash',
    wall: 'wall-paint-warm',
    style: {
      'sofa-3seat': { color: '#cfc3b2', material: 'fabric', pattern: 'plain', pillowColor: '#b48a6a' },
      armchair: { color: '#cbb79f', material: 'fabric', style: 'standard' },
      rug: { color: '#e6ddca', borderColor: '#c8b89c', pattern: 'plain' },
      'bed-queen': { frameColor: '#cdb696', beddingColor: '#efe9dc', headboardStyle: 'upholstered' },
    ...
    rooms: {
      ...
      bedroom3: [
        { id: 'default-b3-crib', defId: 'crib', position: [8.5, 1.4], rotation: -Math.PI / 2, props: { endStyle: 'slat', color: '#efe9dc', finish: 'painted', mattressColor: '#d6e2dc', mattressLevel: 'high' } },
        { id: 'default-b3-changer', defId: 'dresser', position: [6.45, 1.0], rotation: Math.PI / 2, props: { width: 1.2, rows: 3, color: '#cdb696', handle: 'knob' } },
        { id: 'default-b3-glider', defId: 'armchair', position: [7.5, 3.0], rotation: Math.PI, props: { style: 'standard', material: 'fabric', color: '#b48a6a' } },
        { id: 'default-b3-lamp', defId: 'floor-lamp', position: [6.4, 3.1], rotation: 0.6, props: { base: 'arc', shade: 'drum', poleColor: '#3a3026' } },
        { id: 'default-b3-rug', defId: 'rug', position: [7.4, 2.4], rotation: 0, props: { width: 1.6, depth: 1.2, color: '#e6ddca', borderColor: '#c8b89c', pattern: 'plain' } },
        { id: 'default-b3-pendant', defId: 'ceiling-light', position: [7.5, 1.9], rotation: 0, props: { style: 'flush' } },
        { id: 'default-b3-plant', defId: 'potted-plant', position: [8.55, 3.0], rotation: 0, props: { size: 'small', type: 'snake' } },
        { id: 'default-b3-art', defId: 'wall-art', position: [6.14, 2.4], rotation: Math.PI / 2, props: { width: 0.7, height: 0.5, artColor: '#b48a6a' } },
      ],
    },
  },
  {
...
export function buildPresetItems(preset: LayoutPreset): LayoutEntry[] {
  ...
  const overrideItems = (Object.values(overrides).flat() as LayoutEntry[]).map((e) => hydrate(e, {}));
