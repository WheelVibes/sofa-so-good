...
const VariantZ = z
  .object({
    ...
    glb_segments: z
      .array(z.object({ mesh: z.string().nullable(), material: z.string().nullable() }))
      .optional(),
  })
  .passthrough()
...
export type ParseResult = { ok: true; data: IkeaMetadata } | { ok: false; reason: string }
